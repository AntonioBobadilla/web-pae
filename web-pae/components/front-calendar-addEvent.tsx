...
const addEvent = (props) => {
  ...
  return (
    <div className={styles.wrap}>
        <select className={styles.select} name="dia" id="dia" onChange={handleDia}>
        ...
        <select className={styles.select} name="horaInicio" id="horaInicio" onChange={handleInicio}>
        ...
        <select className={styles.select} name="horaFin" id="horaFin" onChange={handleFin}>
        ...
        <button className={styles.addEventButton} onClick={handleSubmit}>Añadir</button>
    </div>
  );
};
